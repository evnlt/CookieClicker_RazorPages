        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CookieAmount = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasicProduction = table.Column<int>(nullable: false),
                    UpgradePercent = table.Column<int>(nullable: false),
                    AmountOwned = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
